...
export PATH=/public3/home/sc71468/soft/vasp/6.5.1-vtst/bin:/opt/slurm/slurm/sbin:/opt/slurm/slurm/bin:/usr/local/bin:/usr/bin:/usr/local/sbin:/usr/sbin:/opt/ibutils/bin
export LD_LIBRARY_PATH=/opt/slurm/slurm/lib:/lib64:/usr/lib64:/usr/local/lib64
if ! source /public3/home/sc71468/soft/toolchain/vasp651.env; then
    echo "Error: Failed to load the VASP toolchain environment." >&2
    exit 1
fi
