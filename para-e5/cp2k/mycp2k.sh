...
TMP_SCRIPT=$(mktemp "${TMPDIR:-/tmp}/mycp2k-${USER:-user}-${JOB_NAME}.XXXXXX")
...
export PATH=/opt/slurm/slurm/sbin:/opt/slurm/slurm/bin:/usr/local/bin:/usr/bin:/usr/local/sbin:/usr/sbin:/opt/ibutils/bin:/publicfs01/fs1-9/home/sc32041/soft/cp2k/latest/install/bin
export LD_LIBRARY_PATH=/opt/slurm/slurm/lib:/lib64:/usr/lib64:/usr/local/lib64:/publicfs01/fs1-9/home/sc32041/soft/cp2k/latest/install/lib64
if ! source /publicfs01/fs1-9/home/sc32041/soft/cp2k/latest/install/cp2k_env; then
    echo "Error: Failed to load the CP2K environment." >&2
    exit 1
fi
if ! source /publicfs01/fs1-9/home/sc32041/soft/ucx/1.21-gcc-14.3/env.sh; then
